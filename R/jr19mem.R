...
#' @examples
#' attributes <- expand.grid(a1=0:1,a2=0:1)[rep(1:4,5),]
#' prices <- rep(c(0,.5,.5,1),5)
#' subj_values <- rep(c(2,0.2,0.1,2), 5)
#' choices <- rep(c(1,0,0,1),5)
