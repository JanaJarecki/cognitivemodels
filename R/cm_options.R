...
#' @param fit_measure A string (default `"loglikelihood"`), the goodnes of fit measure that is optimized during parameter estimation. Can be one of the `types` in the function [cognitiveutils::gof()]:
...
#' @param solver A string, the alorithm to optinize the free parameters. Run [cm_solvers()] to list the options. Changing this may cause warnings about ignored options and may cause parameter bounds to be ignored and the model to fail. Examples:
