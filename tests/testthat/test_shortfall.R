...
# Load shortfall test data
data(shortfalltest)

# Do tests
test_that('Values of estimated parameters', {
  d2  <- shortfalltest[shortfalltest$id==2,]
  d5  <- shortfalltest[shortfalltest$id==5,]
  d14 <- shortfalltest[shortfalltest$id==14,]

  fml <- choice ~ a1 + a2 + a3 + a4 + a5 + pa1 + pa2 + pa3 + pa4 + pa5 | b1 + b2 + b3 + b4 + b5 + pb1 + pb2 + pb3 + pb4 + pb5
